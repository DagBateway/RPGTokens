export const TRANSLATIONS = {
  en: {
    ...
    docTitle: "Paper Tokens Generator | Custom Tabletop RPG Tokens & Standee Pawns",
    docDescription: "Generate and print custom creature tokens, monster initiative tents, and fold-and-cut paper standee pawns for D&D, Pathfinder, and TTRPG battle maps. Immersive, quick, and free!",
    ...
    // Intro Section
    introLead: "Paper Tokens Generator is a free, premium companion tool designed for Dungeon Masters (DMs) and Tabletop RPG players to instantly generate custom physical miniatures. Print round/square creature tokens, monster initiative tents, and fold-and-cut paper standee pawns for Dungeons & Dragons (D&D), Pathfinder, Fate, Savage Worlds, or any other d20 tabletop game.",
    ...
    craftDesc: "Once printed on thick paper or cardstock, you can cut out the circles and easily glue them to supports for a solid, tactile feel at the table. Here are the most popular DIY token supports chosen by DMs:",
    amazonUs: "Amazon US",
    amazonIt: "Amazon IT",
    amazonAus: "Amazon AUS",
    craftFeltPads: "Felt pads",
    craftDomes: "Adhesive Transparent Domes",
    craftWoodenDiscs: "Wooden discs",
    craftPlasticDiscs: "Plastic discs",
    craftWoodenSquares: "Wooden squares",
    ...
    // Print & Actions
    btnPrint: "Print",
    printFootnote: "*In order to fit Large and Huge paper minis in an A4 page, I suggest customising the margins when you print the PDF (5mm margins should be enough).",
  ...
  it: {
    // SEO & Document Metadata
    docTitle: "Generatore di Token Cartacei | Miniature e Pedine RPG Personalizzate",
    docDescription: "Genera e stampa token personalizzati, tendina per l'iniziativa e pedine cartacee pieghevoli per mappe d20, D&D e Pathfinder. Immersivo, veloce e gratuito!",
    ...
    // Intro Section
    introLead: "Il Generatore di Token Cartacei è uno strumento gratuito e premium progettato per Dungeon Master (DM) e giocatori di giochi di ruolo da tavolo per generare all'istante miniature fisiche personalizzate. Stampa token di creature rotondi o quadrati, tendina di iniziativa per i mostri e pedine di carta pieghevoli per Dungeons & Dragons (D&D), Pathfinder, Fate, Savage Worlds o qualsiasi altro gioco di ruolo d20.",
    ...
    craftDesc: "Una volta stampati su carta spessa o cartoncino, puoi ritagliare i cerchi e incollarli facilmente su dei supporti per un feeling solido e tattile al tavolo. Ecco i supporti fai-da-te più popolari scelti dai DM:",
    amazonUs: "Amazon USA",
    amazonIt: "Amazon Italia",
    amazonAus: "Amazon Australia",
    craftFeltPads: "Feltrini adesivi",
    craftDomes: "Cupole adesive trasparenti",
    craftWoodenDiscs: "Dischi di legno",
    craftPlasticDiscs: "Dischi di plastica",
    craftWoodenSquares: "Quadratini di legno",
    ...
    // Print & Actions
    btnPrint: "Stampa",
    printFootnote: "*Per far rientrare le miniature di carta Grandi ed Enormi in una pagina A4, ti suggerisco di personalizzare i margini quando stampi il PDF (i margini da 5 mm dovrebbero essere sufficienti).",
